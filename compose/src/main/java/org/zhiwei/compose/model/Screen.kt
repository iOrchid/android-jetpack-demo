...
import org.zhiwei.compose.screen.basic.BoxColumnRowScreen
import org.zhiwei.compose.screen.basic.SurfaceShapeClickableScreen
...
internal object BasicScreenUIs {
    ...
    internal fun basicCourses(modifier: Modifier = Modifier) = listOf(
        ...
        ) { BoxColumnRowScreen(modifier) },
        CourseItemModel(
            "Surface，Shape，Clickable",
            "面板，图形，绘制背景，点击交互，偏移，权重等。"
        ) { SurfaceShapeClickableScreen(modifier) },
