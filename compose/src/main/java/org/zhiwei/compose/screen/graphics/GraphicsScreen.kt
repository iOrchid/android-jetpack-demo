...
import org.zhiwei.compose.model.GraphicsScreenUIs

@Composable
fun Graphics_Screen(navController: NavController) {
    LazyColumn {
        items(GraphicsScreenUIs.layoutCourses()) { model ->
            ListItem(
                modifier = Modifier
                    .wrapContentHeight()
...
@Preview
@Composable
private fun PreviewGraphicsScreen() {
    Graphics_Screen(rememberNavController())
}