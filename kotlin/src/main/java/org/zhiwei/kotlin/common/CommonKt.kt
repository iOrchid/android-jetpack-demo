package org.zhiwei.kotlin.common
...
//密封类就主要用于替换枚举，用于一些要求宽泛的限定数据类型的地方
	...
	private fun testT() {
		...
		val 她 =
			Tc01<String>("她，目前来说，不少编程语言的变量和函数声明可以使用中文名称，但是不保证一定没问题，所以呢，保持规范，还是标准命名规范")
		println(她.value)
		她.value is String
...
typealias NoStringArgs = (str: String) -> Int//也可以给匿名函数定义别名
